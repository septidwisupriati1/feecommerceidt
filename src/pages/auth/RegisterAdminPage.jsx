...
export default function RegisterAdminPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(result.message || 'Registrasi admin berhasil! Silakan cek email Anda untuk verifikasi.');
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-center">
              <div className="inline-flex items-center px-4 py-2 bg-purple-100 text-purple-800 rounded-full">
                ...
                <span className="font-medium">Akun Administrator</span>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                <strong>Catatan:</strong> Akun admin memiliki akses penuh ke semua fitur platform. Pastikan Anda memiliki otorisasi untuk membuat akun admin.
              </p>
            </div>
